            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('proyecto.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('fec_creaacion') ? ' has-error' : '' }}">
                            <label for="fec_creaacion" class="col-md-4 control-label">Fecha creación</label>

                            <div class="col-md-6">
                                <input id="fec_creaacion" type="date" class="form-control" name="fec_creaacion" value="{{ old('fec_creaacion') }}" required autofocus>

                                @if ($errors->has('fec_creaacion'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('fec_creaacion') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
