        ...
        <div class="col-sm-6 col-md-6 col-lg-4">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <!-- Para contenr el limite de caractes de comentarios-->
                    <p>{{ str_limit($proyecto->observaciones, $limit = 40, $end = ' ...') }}</p>
                    <p>Evaluaciones realizadas: {{count($proyecto->respuestas)}}</p>

                    <a href="{{ route('evaluacion.ver', $proyecto->id) }}" class="btn btn-default btn-block" role="button"><span class="glyphicon glyphicon-folder-open text-primary"></span> 
